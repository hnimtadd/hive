...
func ToTaskUpdateSuccess(msg *bee.QueenOutput) *agentv1.ServerMessage {
...
func ToTaskUpdateFailed(msg *bee.QueenOutput) *agentv1.ServerMessage {
	update := &agentv1.ServerMessage{}
...
func ToTaskUpdateInProgress(msg *bee.QueenOutput) *agentv1.ServerMessage {
	update := &agentv1.ServerMessage{}
...
func ToTaskUpdateRequireFeedback(msg *bee.QueenOutput) *agentv1.ServerMessage {
	update := &agentv1.ServerMessage{}
